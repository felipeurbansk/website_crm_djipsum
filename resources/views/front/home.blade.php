...
@section('content')
    <!-- Hero Section Begin -->
    <section class="hero spad set-bg" data-setbg="front/assets/img/hero-bg.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="event__slider owl-carousel">
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="front/assets/img/events/event-1.jpg">
                                <div class="tag-date">
                    ...
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="front/assets/img/events/event-2.jpg">
                                <div class="tag-date">
                                    <span>Dec 15, 2019</span>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="event__item">
                            <div class="event__item__pic set-bg" data-setbg="front/assets/img/events/event-3.jpg">
                                <div class="tag-date">
                                    <span>Dec 15, 2019</span>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about__pic">
                        <img src="front/assets/img/about/about.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="services__left set-bg" data-setbg="front/assets/img/services/service-left.jpg">
                    ...
                    <div class="row services__list">
                        <div class="col-lg-6 p-0 order-lg-1 col-md-6 order-md-1">
                            <div class="service__item deep-bg">
                                <img src="front/assets/img/services/service-1.png" alt="">
                                <h4>Wedding</h4>
                        ...
                        <div class="col-lg-6 p-0 order-lg-2 col-md-6 order-md-2">
                            <div class="service__item">
                                <img src="front/assets/img/services/service-2.png" alt="">
                                <h4>Clubs and bar</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 p-0 order-lg-4 col-md-6 order-md-4">
                            <div class="service__item deep-bg">
                                <img src="front/assets/img/services/service-4.png" alt="">
                                <h4>DJ lessons</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 p-0 order-lg-3 col-md-6 order-md-3">
                            <div class="service__item">
                                <img src="front/assets/img/services/service-3.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 p-0">
                    <div class="track__pic">
                        <img src="front/assets/img/track-right.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="front/assets/img/youtube/youtube-1.jpg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="front/assets/img/youtube/youtube-2.jpg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="youtube__item">
                        <div class="youtube__item__pic set-bg" data-setbg="front/assets/img/youtube/youtube-3.jpg">
    ...
    <section class="countdown spad set-bg" data-setbg="front/assets/img/countdown-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
